...
func DefaultDictionary() *Dictionary {
	defaultOnce.Do(func() {
		defaultDict = &Dictionary{
			...
			Seasons: []string{
				"летний", "зимний", "весенний", "осенний", "демисезонный",
				"утеплённый", "лёгкий",
			},
			Colors: []string{
				// Базовые
				"чёрный", "белый", "красный", "синий", "зелёный", "жёлтый",
				"серый", "розовый", "голубой", "бежевый", "коричневый", "фиолетовый",
				"оранжевый", "бордовый", "хаки", "молочный", "кремовый",
				// Трендовые
				"терракотовый", "лавандовый", "мятный", "коралловый", "изумрудный",
				"горчичный", "пудровый", "персиковый", "сиреневый", "бирюзовый",
				"графитовый", "индиго", "фуксия", "марсала", "тауп",
				// Принты
				"в цветочек", "в полоску", "в клетку", "в горошек", "леопардовый",
				"камуфляж", "однотонный", "с принтом",
			},
			Occasions: []string{
